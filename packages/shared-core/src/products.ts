...
const productDefinitions: ProductDefinition[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      createVariant("With DAC (5mg)", 50, { mockupLabel: "/products/label-cjc-1295-dac-5mg-3ml.png", testResultUrl: "https://coas.freedomdiagnosticstesting.com/Affo2605210351.pdf" }),
