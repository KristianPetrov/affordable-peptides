      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-xs text-zinc-300">
            With your consent, we use cookies and similar technologies
            (including the TikTok Pixel) to measure site usage and improve our
            store. By selecting &quot;Accept&quot;, you consent to these
            analytics technologies. You can refuse or withdraw consent at any
            time by clearing this site&apos;s stored data in your browser.
          </p>
        </div>
