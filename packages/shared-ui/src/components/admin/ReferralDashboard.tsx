...
type ReferralDashboardProps = {
  ...
  actions: ReferralDashboardActions;
};
...
export default function ReferralDashboard({ data, actions }: ReferralDashboardProps) {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <form
          action={actions.createReferralPartnerAction}
        ...
        <form
          action={actions.createReferralCodeAction}
          className="rounded-3xl border border-purple-900/60 bg-linear-to-br from-[#150022] via-[#090012] to-black p-6"
        >
          <div className="flex flex-col gap-2 border-b border-purple-900/40 pb-4">
            <p className="text-xs uppercase tracking-[0.3em] text-purple-200">
                ...
                >
                  <header className="flex flex-col gap-4 border-b border-purple-900/30 pb-4 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <form action={actions.toggleReferralPartnerStatusAction}>
                      ...
                      <form action={actions.deleteReferralPartnerAction}>
                        <input type="hidden" name="partnerId" value={partner.id} />
                        <button
                          type="submit"
                            ...
                            >
                              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                  ...
                                  <form action={actions.toggleReferralCodeStatusAction}>
                                ...
                                <form action={actions.deleteReferralCodeAction}>
                                  <input type="hidden" name="codeId" value={code.id} />
                                  <button
                                    type="submit"
